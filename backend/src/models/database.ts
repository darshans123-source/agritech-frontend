    ...
    const crops: Crop[] = [
      {
        ...
        healthScore: 92,
        status: 'Healthy',
        irrigationSchedule: 'Every 5 days (Canal / Drip)',
        fertilizerSchedule: 'Top dressing with Nano Urea in 8 days',
        projectedYieldKg: 185000,
        expectedRevenue: 555000,
        timeline: [
          { id: 'seed', name: 'Sett Planting & Furrowing', status: 'completed', progress: 100, estimatedDate: 'Feb 10, 2026', notes: 'Soil treated with Trichoderma viride', tasks: ['Deep plowing', 'Sett fungicide dipping'] },
          { id: 'germination', name: 'Tillering & Sprouting', status: 'completed', progress: 100, estimatedDate: 'Mar 25, 2026', notes: '94% germination success across all rows', tasks: ['First weeding', 'Basal NPK dose'] },
          { id: 'growth', name: 'Grand Growth & Stem Elongation', status: 'active', progress: 65, estimatedDate: 'Jul - Oct 2026', notes: 'Optimal cane girth observed; monitor borer moths', tasks: ['Earthing up', 'Foliar zinc spray'] },
          { id: 'flowering', name: 'Maturity & Sucrose Accumulation', status: 'upcoming', progress: 0, estimatedDate: 'Nov 15, 2026', notes: 'Sugar brix testing before factory schedule', tasks: ['Stop nitrogen', 'Reduce irrigation'] },
          { id: 'harvest', name: 'Harvesting & Mill Transport', status: 'upcoming', progress: 0, estimatedDate: 'Dec 20, 2026', notes: 'Pre-booked slot at Pandavapura Sugar Mill', tasks: ['Coordinate labor crew', 'Truck logistics'] }
        ]
      },
      {
        id: 'crop-2',
        ...
        irrigationSchedule: 'Daily drip (45 mins at 06:30 AM)',
        fertilizerSchedule: '19:19:19 fertigation twice a week',
        projectedYieldKg: 28000,
        expectedRevenue: 392000,
        timeline: [
          { id: 'seed', name: 'Nursery Raising & Pro-tray', status: 'completed', progress: 100, estimatedDate: 'Jun 01, 2026', notes: 'Germination rate 98% in shade net house', tasks: ['Seed sowing', 'Damping-off drenching'] },
          { id: 'germination', name: 'Field Transplantation', status: 'completed', progress: 100, estimatedDate: 'Jun 28, 2026', notes: 'Silver-black mulching and staking installed', tasks: ['Raised bed prep', 'Transplanting at 45cm'] },
          { id: 'growth', name: 'Vegetative & Branching', status: 'completed', progress: 100, estimatedDate: 'Jul 20, 2026', notes: 'Strong trellising done; minor leaf miner spotted', tasks: ['Bamboo staking', 'Neem oil foliar spray'] },
          { id: 'flowering', name: 'Flowering & Fruit Setting', status: 'active', progress: 80, estimatedDate: 'Aug 15 - Sep 05, 2026', notes: 'High flower load. Early blight spots detected on lower leaves', tasks: ['Spray Mancozeb / Bio-fungicide', 'Calcium-Boron spray'] },
          { id: 'harvest', name: 'Picking & Sorting for Mandi', status: 'upcoming', progress: 0, estimatedDate: 'Sep 18, 2026', notes: 'KrishiBhavishya forecasts Rs 28/kg peak pricing', tasks: ['Crate procurement', 'Sorting by grade A/B'] }
        ]
      },
      {
        id: 'crop-3',
        ...
        variety: 'GPU-28 Drought Tolerant',
        area: 2.0,
        ...
        healthScore: 96,
        status: 'Healthy',
        irrigationSchedule: 'Rainfed with 1 life-saving sprinkler round',
        fertilizerSchedule: 'Organic vermicompost + Jeevamrutha',
        projectedYieldKg: 3200,
        expectedRevenue: 138000,
        timeline: [
          { id: 'seed', name: 'Direct Sowing & Seed Treatment', status: 'completed', progress: 100, estimatedDate: 'Jul 15, 2026', notes: 'Azospirillum biofertilizer treated', tasks: ['Ploughing', 'Line sowing'] },
          { id: 'germination', name: 'Emergence & Thinning', status: 'completed', progress: 100, estimatedDate: 'Aug 02, 2026', notes: 'Excellent emergence after monsoon shower', tasks: ['Intercultivation', 'Hand weeding'] },
          { id: 'growth', name: 'Tillering & Vegetative Surge', status: 'active', progress: 45, estimatedDate: 'Aug 20 - Sep 30, 2026', notes: 'Pest free; deep green canopy', tasks: ['Jeevamrutha application'] },
          { id: 'flowering', name: 'Earhead Emergence & Grain Filling', status: 'upcoming', progress: 0, estimatedDate: 'Oct 10, 2026', notes: 'Monitor for blast disease', tasks: ['Bird scaring setup'] },
          { id: 'harvest', name: 'Harvesting & Threshing', status: 'upcoming', progress: 0, estimatedDate: 'Nov 05, 2026', notes: 'Straw will be stored for dairy livestock', tasks: ['Reaping', 'Mechanical thresher'] }
        ]
      }
    ];
